<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CustomerDashboardGrid.ascx.cs" Inherits="Controls_CustomerDashboard" className="CustomerDashboardGrid" %>
<%--class="CustomerDashboardGrid"--%>
<!--Jack-->
<table>
    <tr>
        <td>
...
<asp:GridView ID="JobsGridView" runat="server" AllowPaging="True" 
    ...
    <EmptyDataTemplate>
        <asp:Label ID="NoDataLabel" runat="server" 
            Text="There are no jobs to display."></asp:Label>
    </EmptyDataTemplate>
</asp:GridView>
