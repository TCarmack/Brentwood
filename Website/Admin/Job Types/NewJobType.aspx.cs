...
//Jack
public partial class Admin_Job_Types_NewJobType : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!(Page.PreviousPage == null))
        {
            ...
            object jobTypeID = (int)Context.Items["JobTypeID"];
            ...
            if (!(jobTypeID == null))
            {
                ...
                JobTypeID.Value = jobTypeID.ToString();
    ...
    protected void ControlsGridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            List<JobTypeControlCookie> data = JobTypeControlCart.RemoveItemByIndex(e.RowIndex);
    ...
    protected void ControlsGridView_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        else
        {
            ...
            try
            {
                ...
                list.Items.FindByText(Brentwood.GetJobControlTypeByControl(int.Parse(ControlsGridView.DataKeys[e.NewEditIndex].Value.ToString())).ControlTypeName).Selected = true;
            }
            catch (Exception ex)
            {
                FormMessage.ForeColor = Color.Red;
